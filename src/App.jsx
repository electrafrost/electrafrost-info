    ...
    <div className="about-tab">
      <div className="about-content">
        ...
        <div className="about-thesis">
          ...
          <p>As more critical systems are rebuilt with AI, someone with real enforceable duties to the public has to stand between the models and the people they affect. That role requires independent actors with the technical capacity to execute and verify programmable controls, and the authority to hold the people deploying those systems accountable across institutional boundaries.</p>
